...
def init_remote_api_server(PORT):
    ...
    ---
    'PORT':[int]
        the numbr of port where communication has to start
    ...
    Example call:
    ---
    client_id = init_remote_api_server(PORT)
...
# def get_vision_sensor_image():
    ...
    ---
        'client_id':[int]
            The client id from which image has to be fetched
...
#     try:
#         client_id = init_remote_api_server(19997)
...
#     try:
#         vision_sensor_handle=sim.simxGetObjectHandle(client_id,"vision_sensor_1".sim.simx_opmode_blocking)
#         vision_sensor_image, image_resolution, return_code = get_vision_sensor_image(client_id,vision_sensor_handle)
